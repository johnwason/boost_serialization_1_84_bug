...
void testSerialization_xml(const SerializableType& object, const std::string& typename_string)
{
...
template <typename SerializableType>
void testSerialization_binary(const SerializableType& object, const std::string& typename_string)
{   
...
template <typename SerializableType>
void testSerialization_xml_string(const SerializableType& object, const std::string& typename_string)
{
...
void testSerializationDerivedClass_xml(const std::shared_ptr<SerializableTypeBase>& object,
...
template <typename SerializableTypeBase, typename SerializableTypeDerived>
void testSerializationDerivedClass_binary(const std::shared_ptr<SerializableTypeBase>& object,
                                   const std::string& typename_string)
{
  {  // Archive program to binary file
...
template <typename SerializableTypeBase, typename SerializableTypeDerived>
void testSerializationDerivedClass_xml_string(const std::shared_ptr<SerializableTypeBase>& object,
                                   const std::string& typename_string)
{
  {  // Archive program to string
    std::string object_string =
